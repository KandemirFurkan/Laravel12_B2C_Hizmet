...
<div class="admin-header d-flex justify-content-between align-items-center">
        <div>
          ...
          <h4 class="mb-0 ms-2 ms-md-0">Yeni Kategori Ekle</h4>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Kategori adı" required>
                  @error('name')
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="5" placeholder="Kategori açıklaması" required>{{ old('description') }}</textarea>
                  @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
